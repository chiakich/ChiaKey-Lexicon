...
- **National Academy for Educational Research, General Word Frequency List**: the frequency data behind `sources/moe-word-frequency`, used to order candidates that share a weight. The statistics are open and free of charge to the general public for education, research, and other non-profit purposes.
