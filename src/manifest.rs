use crate::config::{
    ...
    CHIAKEY_AUTO_HOTWORDS_SOURCE_ID, CHIAKEY_AUTO_HOTWORDS_SOURCE_NAME,
    CHIAKI_TW_HOMOPHONE_SOURCE_ID, CHIAKI_TW_HOMOPHONE_SOURCE_NAME, CHIAKI_WEB_OVERLAY_SOURCE_ID,
    CHIAKI_WEB_OVERLAY_SOURCE_NAME, DATABASE_SCHEMA_VERSION, FRAGMENT_DENYLIST_SOURCE_ID,
    FRAGMENT_DENYLIST_SOURCE_NAME, LIBCHEWING_SOURCE_ID, LIBCHEWING_SOURCE_NAME,
    MODULE_CIN_SOURCE_ID, MODULE_CIN_SOURCE_NAME, MOZC_EMOTICON_SOURCE_ID,
    MOZC_EMOTICON_SOURCE_NAME, OPENFORMOSA_COMMON_VOICE_SOURCE_ID,
...
pub fn release_metadata(
    ...
    let sources = vec![
        ...
        release_source_from_files(
            ...
            &[&paths.overlay_unigrams, &paths.overlay_explicit, &paths.overlay_bigrams],
